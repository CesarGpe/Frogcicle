...
function Talkies.update(dt)
	...
	if currentMessage:update(dt) then
		...
		elseif not currentDialog.talkSound:isPlaying() then
			local pitch = currentDialog.pitchValues[love.math.random(#currentDialog.pitchValues)]
...
function Talkies.draw()
	...
	love.graphics.scale(Talkies.scale, Talkies.scale)
	love.graphics.translate(Talkies.offsetx / Talkies.scale, Talkies.offsety / Talkies.scale)
